...
tk.Label(root, text="Drawing Number and Ver.:").grid(row=5, column=0, sticky="e")
Drawing_Number_and_Ver = tk.Entry(root)
Drawing_Number_and_Ver.grid(row=5, column=1)

# Create labels for Mold Type and Mold
tk.Label(root, text="Mold Type:").grid(row=6, column=0, sticky="e")
Mold_Type = tk.StringVar(root)
Mold_Type.set(list(mold_options.keys())[0])  # Set default selected option
Mold_Type_Options = tk.OptionMenu(root, Mold_Type, *mold_options.keys())
Mold_Type_Options.grid(row=6, column=1)

tk.Label(root, text="Mold:").grid(row=7, column=0, sticky="e")
Mold_Options = tk.StringVar(root)
Mold_Options_Menu = tk.OptionMenu(root, Mold_Options, "")
...
tk.Label(root, text="Material:").grid(row=8, column=0, sticky="e")
Material = tk.Entry(root)
Material.grid(row=8, column=1)

tk.Label(root, text="Press Location:").grid(row=9, column=0, sticky="e")
Press_Location = tk.Entry(root)
Press_Location.grid(row=9, column=1)

tk.Label(root, text="Process Press Data Sheet:").grid(row=10, column=0, sticky="e")
Press_Process_Data_Sheet = tk.Entry(root)
Press_Process_Data_Sheet.grid(row=10, column=1)

tk.Label(root, text="Control Plan:").grid(row=11, column=0, sticky="e")
Control_Plan = tk.Entry(root)
Control_Plan.grid(row=11, column=1)

tk.Label(root, text="Cavities:").grid(row=12, column=0, sticky="e")
